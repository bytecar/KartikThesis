...
\caption{Goodput graph showing the turnaround time distribution of all the jobs submitted on Tusker via $Condor_G$ bulk submission}
...
\caption{Histogram showing turnaround time distribution of 300 Jobs, when run via $Condor_G$ bulk submission on a custom small scale independent NFS server on Tusker}
